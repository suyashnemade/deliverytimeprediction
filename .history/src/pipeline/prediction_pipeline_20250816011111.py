...
class PredictionPipeline:
    def __init__(self):
        try:
            ...
            """_categorical_columns = ['Type_of_order', 'Type_of_vehicle', 'Festival','city']
    ...
    def get_data_as_dataframe(self):
        try:
            custom_data_input_dict= {
                'Delivery_person Age': [self.Delivery_person_Age],
                'Delivery_person_Ratings': [self.Delivery_person_Ratings],
                'Weather_conditions': [self.Weather_conditions],
                'Road traffic_density': [self.Road traffic_density],
                'Vehicle_condition': [self.Vehicle_condition],
                'multiple_deliveries': [self.multiple_deliveries],
                "distance": [self.distance],
                "Type_of_order": [self. Type_of_order],
                "Type_of_vehicle": [self.Typo_of_vehicle],
            ...
            logging.info("Error occured in custom pipeline datafraem")
            CustomException(e,sys)